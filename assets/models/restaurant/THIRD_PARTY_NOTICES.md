...
`ar/turkish-shish-kebab.glb`, `ar/turkish-adana-kebab.glb` и `ar/turkish-lentil-soup.glb` созданы непосредственно для Alba Space воспроизводимым скриптом `scripts/create-restaurant-turkish-dishes-highpoly.mjs`. Шиш-кебаб и адана-кебаб оставлены как архивные варианты и больше не используются в меню; действующей турецкой моделью из этой группы остаётся чечевичный суп. Сетки содержат соответственно 116 128, 148 864 и 164 000 треугольников. Внешние текстуры и сетевые ресурсы им не требуются.
